...
{
public:
    SuiteTopology6(IReader& aReader);
...
SuiteTopology6::SuiteTopology6(IReader& aReader)
...
void SuiteTopology6::Test1()
{
    ...
    Topology5* topology5 = new Topology5(topology4, *log);
    iTopology6 = new Topology6(topology5, *log);
